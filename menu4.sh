...
export sem=$( curl -s https://raw.githubusercontent.com/mza-xxdv/test/main/versions)
...
echo -e "${BICyan} │"                                                                      │
echo -e "${BICyan} │  ${BICyan}Use Core        :  ${BIPurple}$ MZA-XXDV TUNNELING ${NC}"   │
...
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "     ${BICyan}[${BIWhite}88${BICyan}] CEK-USAGE-RAM ${BICyan}${BIYellow}${BICyan}${NC}"
...
21) clear ; clearlog ;;
99) clear ; update ;;
22) clear ; wget https://raw.githubusercontent.com/mza-xxdv/asd/main/cf.sh && chmod +x cf.sh && ./cf.sh ;;
