...
echo -e "\e[33mттттттттттттттттттттттттттттттттттт\033[0m"
echo -e ""
echo -e " [\e[36m1\e[0m] Create Account Trojan Go "
#echo -e " [\e[36m2\e[0m] Trial Account Trojan Go "
echo -e " [\e[36m2\e[0m] Renew Account Trojan Go "
echo -e " [\e[36m3\e[0m] Delete Account Trojan Go "
echo -e " [\e[36m4\e[0m] Check User Login Trojan Go"
echo -e ""
echo -e   ""
echo -e   "Press x or [ Ctrl+C ] тЂ To-Exit"
echo ""
echo -e "\e[33mттттттттттттттттттттттттттттттттттт\033[0m"
echo -e ""
